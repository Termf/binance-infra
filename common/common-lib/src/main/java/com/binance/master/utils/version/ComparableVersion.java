 ...
 * <li>strings are checked for well-known qualifiers and the qualifier ordering is used for version
 * ordering. Well-known qualifiers (case insensitive) are:
 * <ul>
 ...
 * insensitive),</li>
 * <li>a dash usually precedes a qualifier, and is always less important than something preceded
 * with a dot.</li>
 * </ul>
 * </p>
 *
...
public class ComparableVersion implements Comparable<ComparableVersion> {
    ...
    private static class StringItem implements Item {
        ...
        /**
         * A comparable value for the empty-string qualifier. This one is used to determine if a
         * given qualifier makes the version older than one without a qualifier, or more recent.
         */
         ...
         * comparisons are decided by the first character, so this is still fast. If more characters
