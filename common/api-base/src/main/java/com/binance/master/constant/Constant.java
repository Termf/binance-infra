...
public final class Constant {
    ...
    public static final String COOKIE_TOKEN_V2 = "p20t";
    ...
    public static final String COOKIE_NEW_CSRFTOKEN_V2 = "cr00";
    ...
    // 退出时需要清理的cookie
    public static final List<String> CLEAR_COOKIE_LIST = Arrays.asList(COOKIE_TOKEN, COOKIE_TOKEN_V2, COOKIE_MIX_TOKEN1, COOKIE_MIX_TOKEN2,
            COOKIE_MIX_TOKEN3, COOKIE_SERIAL_NO, COOKIE_NEW_CSRFTOKEN, COOKIE_NEW_CSRFTOKEN_V2);

    // 退出时需要清理的老pnk系统中的cookie
    public static final List<String> CLEAR_OLD_COOKIE_LIST = Arrays.asList(COOKIE_CSRFTOKEN, JSESSIONID,COOKIE_TOKEN_V2,COOKIE_NEW_CSRFTOKEN_V2);
