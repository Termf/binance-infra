...
public class LoadBalancedRetryPolicyEnhance extends RibbonLoadBalancedRetryPolicy {
	protected static final Logger LOGGER = LoggerFactory.getLogger(LoadBalancedRetryPolicy.class);
	// 默认重试最大次数
	private int MAX_RETRY_TIMES = 0;
	 ...
	 * </pre>
	 */
	protected final List<Class<? extends Throwable>> SERVER_HAVE_NOT_RECEIVE = Lists
			.<Class<? extends Throwable>>newArrayList(ConnectException.class, ConnectTimeoutException.class,
	 ...
	 * </pre>
	 */
	protected final List<Class<? extends Throwable>> SERVER_HAVE_RECEIVE = Lists
			.<Class<? extends Throwable>>newArrayList(SocketTimeoutException.class, ConnectionClosedException.class);
	...
	public LoadBalancedRetryPolicyEnhance(String serviceId, RibbonLoadBalancerContext context,
		...
		MAX_RETRY_TIMES = max_retry_times != null ? Integer.valueOf(max_retry_times) : 0;
	}
	...
	public boolean canRetry(LoadBalancedRetryContext context) {
		...
		if (MAX_RETRY_COUNT > MAX_RETRY_TIMES) {
			MAX_RETRY_COUNT = 0;
			return false;
		}
		// 首先看下是否是get请求
