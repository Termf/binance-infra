...
public class EurekaConstants {
    ...
    public static final String PROVIDER_INSTANCE_WARMUP = "spring.application.warmup";
    public static final String PROVIDER_INSTANCE_WARMUP_DELAY_TIME = "spring.application.warmup.delaytime";
    ...
    public static final String EUREKA_METADATA_WARMUP = "warmup";
    public static final String EUREKA_METADATA_WARMUP_DELAY_TIME = "warmup.delay.time";
    ...
    public static final String EUREKA_META_ENVKEY_GRAY = "gray";

    public static final String REDEFINE_FEIGNCLIENT_NAME = "x-redefine-feignclient";
