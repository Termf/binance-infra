...
import com.binance.platform.monitor.model.HaloMetricResponse;
...
public class MetricsInfoEndpoint {
    ...
    public HaloMetricResponse HaloMetric() {
        ...
        haloMetricResponse
            .setJvmMemoryUsedNonHeap(String.valueOf(jvmNemoryUsedNonHeap.getMeasurements().get(0).getValue()));
        ...
        if (systemLoadAverage != null) {
            haloMetricResponse
                .setSystemloadAverage(String.valueOf(systemLoadAverage.getMeasurements().get(0).getValue()));
        }
