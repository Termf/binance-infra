...
//
//import static com.binance.platform.monitor.metric.system.OshiProcessorMetrics.ProcessorMetric.*;
//
...
//
///**
// * Collects CPU (percent and/or time total) and system load (1m, 15m, 15m) from
// * host.
// *
// * Time total is most useful for i.e prometheus while percent might be more
// * useful for i.e influxdb or elastic.
// *
// * @author Johan Rask (jrask)
// */
//public class OshiProcessorMetrics implements MeterBinder {
//
...
//		ALL, SECONDS_TOTAL, PERCENT
//	}
//
//	protected enum ProcessorMetric {
//		USER_PERCENT, NICE_PERCENT, SYSTEM_PERCENT, IDLE_PERCENT, IOWAIT_PERCENT, IRQ_PERCENT, SOFTIRQ_PERCENT,
//		STEAL_PERCENT,
//
//		LOAD_1M, LOAD_5M, LOAD_15M,
//
//		USER_TIME_SECONDS_TOTAL, NICE_TIME_SECONDS_TOTAL, SYS_TIME_SECONDS_TOTAL, IDLE_TIME_SECONDS_TOTAL,
//		IOWAIT_TIME_IN_SECONDS_TOTAL, IRQ_TIME_IN_SECONDS_TOTAL, SOFTIRQ_TIME_IN_SECONDS_TOTAL,
...
//			TICKS_PER_SEC = ParseUtil.parseLongOrDefault(ExecutingCommand.getFirstAnswer("getconf CLK_TCK"), -1L);
//			if (TICKS_PER_SEC == -1) {
...
//
//	/**
//	 * Read the value of a specific value. This method mainly exists to make sure
//	 * that refresh() is invoked properly instead of invoking it in each Meter.
//	 */
...
//		switch (type) {
//		case USER_PERCENT:
//			return calculatedCpuMetrics.user;
//		case NICE_PERCENT:
//			return calculatedCpuMetrics.nice;
//		case SYSTEM_PERCENT:
//			return calculatedCpuMetrics.sys;
//		case IDLE_PERCENT:
//			return calculatedCpuMetrics.idle;
//		case IOWAIT_PERCENT:
//			return calculatedCpuMetrics.iowait;
//		case IRQ_PERCENT:
//			return calculatedCpuMetrics.irq;
//		case SOFTIRQ_PERCENT:
//			return calculatedCpuMetrics.softirq;
//		case STEAL_PERCENT:
//			return calculatedCpuMetrics.steal;
//
//		case LOAD_1M:
//			return calculatedCpuMetrics.load1m;
//		case LOAD_5M:
//			return calculatedCpuMetrics.load5m;
//		case LOAD_15M:
//			return calculatedCpuMetrics.load15m;
//
//		case USER_TIME_SECONDS_TOTAL:
//			return calculatedCpuMetrics.userTimeSecondsTotal;
//		case NICE_TIME_SECONDS_TOTAL:
//			return calculatedCpuMetrics.niceTimeInSecondsTotal;
//		case SYS_TIME_SECONDS_TOTAL:
//			return calculatedCpuMetrics.sysTimeInSecondsTotal;
//		case IDLE_TIME_SECONDS_TOTAL:
//			return calculatedCpuMetrics.idleTimeInSecondsTotal;
//		case IOWAIT_TIME_IN_SECONDS_TOTAL:
//			return calculatedCpuMetrics.iowaitTimeInSecondsTotal;
//		case IRQ_TIME_IN_SECONDS_TOTAL:
//			return calculatedCpuMetrics.irqTimeInSecondsTotal;
//		case SOFTIRQ_TIME_IN_SECONDS_TOTAL:
//			return calculatedCpuMetrics.softirqTimeInSecondsTotal;
//		case STEAL_TIME_IN_SECONDS_TOTAL:
//			return calculatedCpuMetrics.stealTimeInSecondsTotal;
//		default:
//			return 0;
//		}
//	}
//
//	/**
//	 * Calculates and caches CPU load, CPU percent and cumulative cpu time in
//	 * seconds.
//	 *
//	 */
...
//					&& (cpuSampleType == CpuSampleType.ALL || cpuSampleType == CpuSampleType.SECONDS_TOTAL)) {
...
//
//		Gauge.builder("system.cpu.usage.pct", ProcessorMetric.USER_PERCENT, this::getCpuMetricAsDouble).tags(tags)
//				.tag("mode", "user").description("User cpu usage in percent").register(meterRegistry);
//
//		Gauge.builder("system.cpu.usage.pct", ProcessorMetric.SYSTEM_PERCENT, this::getCpuMetricAsDouble).tags(tags)
//				.tag("mode", "system").description("System cpu usage in percent").register(meterRegistry);
//
//		Gauge.builder("system.cpu.usage.pct", ProcessorMetric.IDLE_PERCENT, this::getCpuMetricAsDouble).tags(tags)
//				.tag("mode", "idle").description("Idle cpu usage in percent").register(meterRegistry);
//
//		Gauge.builder("system.cpu.usage.pct", ProcessorMetric.NICE_PERCENT, this::getCpuMetricAsDouble).tags(tags)
//				.tag("mode", "nice").description("Nice cpu usage in percent").register(meterRegistry);
//
//		Gauge.builder("system.cpu.usage.pct", ProcessorMetric.IRQ_PERCENT, this::getCpuMetricAsDouble).tags(tags)
//				.tag("mode", "irq").description("IRQ cpu usage in percent").register(meterRegistry);
//
//		Gauge.builder("system.cpu.usage.pct", ProcessorMetric.SOFTIRQ_PERCENT, this::getCpuMetricAsDouble).tags(tags)
//				.tag("mode", "irq").description("SOFTIRQ cpu usage in percent").register(meterRegistry);
//	}
//
...
//
//		Gauge.builder("system.load.1m", ProcessorMetric.LOAD_1M, this::getCpuMetricAsDouble).tags(tags)
//				.tag("cpus", String.valueOf(cpuCount)).description("System load 1m").register(meterRegistry);
//
//		Gauge.builder("system.load.5m", ProcessorMetric.LOAD_5M, this::getCpuMetricAsDouble).tags(tags)
//				.tag("cpus", String.valueOf(cpuCount)).description("System load 5m").register(meterRegistry);
//
//		Gauge.builder("system.load.15m", ProcessorMetric.LOAD_15M, this::getCpuMetricAsDouble).tags(tags)
//				.tag("cpus", String.valueOf(cpuCount)).description("System load 15m").register(meterRegistry);
//	}
//
...
//					.tags(tags).tag("mode", "user").description("User cpu usage in percent").register(meterRegistry);
//
//			FunctionCounter.builder("system.cpu.seconds.total", IDLE_TIME_SECONDS_TOTAL, this::getCpuMetricAsDouble)
//					.tags(tags).tag("mode", "idle").description("User cpu idle in percent").register(meterRegistry);
//
//			FunctionCounter.builder("system.cpu.seconds.total", SYS_TIME_SECONDS_TOTAL, this::getCpuMetricAsDouble)
//					.tags(tags).tag("mode", "system").description("User cpu usage in percent").register(meterRegistry);
//
//			FunctionCounter.builder("system.cpu.seconds.total", IRQ_TIME_IN_SECONDS_TOTAL, this::getCpuMetricAsDouble)
//					.tags(tags).tag("mode", "irq").description("User cpu irq in percent").register(meterRegistry);
//
//			FunctionCounter
//					.builder("system.cpu.seconds.total", SOFTIRQ_TIME_IN_SECONDS_TOTAL, this::getCpuMetricAsDouble)
//					.tags(tags).tag("mode", "softirq").description("User cpu softirq in percent")
//					.register(meterRegistry);
//
//			FunctionCounter.builder("system.cpu.seconds.total", STEAL_TIME_IN_SECONDS_TOTAL, this::getCpuMetricAsDouble)
//					.tags(tags).tag("mode", "steal").description("User cpu steal in percent").register(meterRegistry);
//
//		} else {
