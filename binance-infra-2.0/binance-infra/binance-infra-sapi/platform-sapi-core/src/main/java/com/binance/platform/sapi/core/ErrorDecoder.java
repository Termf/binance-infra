...
import com.binance.platform.sapi.exception.SapiException;
...
public interface ErrorDecoder {
    ...
    default RuntimeException invalidRespDecode(Request request, Response response) {
        if (!response.isSuccessful()) {
            throw SapiException.errorStatus(request, response);
        }
        return null;
    }
    ...
    default RuntimeException ioExceptionDecode(Request request, IOException cause) {
        return SapiException.errorExecuting(request, cause);
    }
    ...
    default RuntimeException exceptionDecode(Request request, Exception cause) {
        return SapiException.errorUnknown(request, cause);
    }
