...
import com.binance.platform.sapi.retry.DefaultRetryInterceptor;
import com.binance.platform.sapi.retry.BaseRetryInterceptor;
import com.binance.platform.sapi.retry.Retry;
import com.binance.platform.sapi.retry.RetryRule;
...
public class RetryProperty {
     ...
     */
    private int globalMaxRetries = 0;
