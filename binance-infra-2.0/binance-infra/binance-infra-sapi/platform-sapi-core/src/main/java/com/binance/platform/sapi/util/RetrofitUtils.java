package com.binance.platform.sapi.util;

import com.binance.platform.sapi.annotation.Sapi;
import com.binance.platform.sapi.exception.ReadResponseBodyException;
...
public final class RetrofitUtils {
    ...
    public static String convertBaseUrl(Sapi sapi, String baseUrl, Environment environment) {
