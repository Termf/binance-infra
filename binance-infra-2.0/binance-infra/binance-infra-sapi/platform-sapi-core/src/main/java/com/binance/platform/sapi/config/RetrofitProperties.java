...
import com.binance.platform.sapi.core.BasicTypeConverterFactory;
import com.binance.platform.sapi.core.BodyCallAdapterFactory;
import com.binance.platform.sapi.core.ResponseCallAdapterFactory;
 ...
 * @author 陈添明
 */
@ConfigurationProperties(prefix = "com.binance.infra.sapi")
public class RetrofitProperties {
     ...
     * 全局连接超时时间
     */
    private int globalConnectTimeoutMs = 1_000;
    ...
    public Map<String, PoolConfig> getPool() {
        ...
        pool.put(DEFAULT_POOL, new PoolConfig(5, 55));
        return pool;
    }
