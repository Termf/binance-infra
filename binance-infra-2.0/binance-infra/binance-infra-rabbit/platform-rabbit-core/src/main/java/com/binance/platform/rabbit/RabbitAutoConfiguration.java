...
import com.binance.platform.rabbit.delay.DelayQueueScaner;
import com.binance.platform.rabbit.extend.RabbitTemplateExtend;
import com.binance.platform.rabbit.logger.AbstractTraceLog;
import com.binance.platform.rabbit.logger.DatabaseMySQLTraceLogger;
import com.binance.platform.rabbit.logger.NoopTraceLogger;
import com.binance.platform.rabbit.logger.Slf4jTraceLogger;
import com.rabbitmq.client.Channel;

@Configuration
@ConditionalOnClass({RabbitTemplate.class, Channel.class})
@EnableConfigurationProperties({RabbitProperties.class, org.springframework.boot.autoconfigure.amqp.RabbitProperties.class})
...
public class RabbitAutoConfiguration {
    ...
    public void init() {
        ...
        if (env.containsProperty(RABBIT_TRACE_LOG_TYPE_KEY)) {
            ...
            /**
             *  jun fan -- frank.fan@binance.com
             *  阉割版本，避免进行数据库存储，污染应用系统数据库
             *
            if (dataSource != null
