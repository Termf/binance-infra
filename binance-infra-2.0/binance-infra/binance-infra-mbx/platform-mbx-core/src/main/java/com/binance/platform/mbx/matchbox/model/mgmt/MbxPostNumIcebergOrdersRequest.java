 ...
 */
public class MbxPostNumIcebergOrdersRequest extends MbxBaseRequest {
    @Override
    ...
    public MbxPostNumIcebergOrdersRequest(@NotEmpty String numOrders, @NotEmpty String symbol) {
