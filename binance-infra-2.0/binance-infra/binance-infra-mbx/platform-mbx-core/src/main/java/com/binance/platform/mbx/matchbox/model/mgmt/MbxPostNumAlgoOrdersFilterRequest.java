 ...
 */
public class MbxPostNumAlgoOrdersFilterRequest extends MbxBaseRequest {
    @Override
    ...
    public MbxPostNumAlgoOrdersFilterRequest(@NotEmpty String numOrders, @NotEmpty String symbol) {
