 ...
 */
public class MbxGetMsgAuthOrdersRequest extends MbxBaseRequest {
    @Override
    public String getUri() {
        return "/v1/msgAuthOrders";
    }
    ...
    public MbxGetMsgAuthOrdersRequest(long startTime, @NotEmpty String msgAuth) {
