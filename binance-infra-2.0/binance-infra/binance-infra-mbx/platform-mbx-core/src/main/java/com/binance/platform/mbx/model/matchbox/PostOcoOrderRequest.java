...
public class PostOcoOrderRequest extends ToString {
    ...
    public PostOcoOrderRequest(long accountId, String symbol, String side, String quantity, String price, String stopPrice) {
