...
public class DeleteOcoOrderRequest extends ToString {
    ...
    /**
     * Either orderListId or listClientOrderId should be provided
     *
     * @param userId
     * @param symbol
     * @param orderId
     */
    public DeleteOcoOrderRequest(long userId, @NotEmpty String symbol, @NotEmpty String orderId) {
        this.userId = userId;
        this.symbol = symbol;
